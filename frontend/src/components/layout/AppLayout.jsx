        ...
        <div className="flex min-h-screen">
          ...
          <main className="flex-1 flex flex-col">
            <header className="flex items-center justify-between px-6 py-4 border-b bg-white dark:bg-slate-800">
              ...
              {/* User display — shows name with email as tooltip, or email if no name */}
              <span
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={logout}
                  className="px-4 py-2 bg-slate-900 text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
                >
                  Logout
                </button>
              </div>
            ...
            <div className="flex-1 p-6 dark:bg-slate-900 dark:text-slate-100">
              {children}
            </div>
          </main>
        </div>
